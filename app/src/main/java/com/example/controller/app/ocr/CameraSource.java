        ...
        synchronized (mCameraLock) {
            ...
            if (mProcessingThread != null) {
                try {
                    ...
                    Log.e(TAG, LogUtil.prependCallLocation("Frame processing thread interrupted on release."));
                }
            ...
            if (mCamera != null) {
                ...
                try {
                    ...
                    Log.e(TAG, LogUtil.prependCallLocation("Failed to clear camera preview: " + e));
                }
                mCamera.release();
                mCamera = null;
            }
    ...
    private void setRotation(Camera camera, Camera.Parameters parameters, int cameraId) {
        ...
        switch (rotation) {
            ...
            case Surface.ROTATION_270:
                ...
                break;
            default:
                Log.e(TAG, LogUtil.prependCallLocation("Bad rotation value: " + rotation));
        }
        ...
        void setNextFrame(byte[] data, Camera camera) {
            synchronized (mLock) {
                ...
                if (!mBytesToByteBuffer.containsKey(data)) {
                    Log.e(TAG, LogUtil.prependCallLocation("Skipping frame.  Could not find ByteBuffer associated with the image " +
        ...
        public void run() {
            ...
            while (true) {
                synchronized (mLock) {
                    while (mActive && (mPendingFrameData == null)) {
                        try {
                            ...
                            Log.e(TAG, LogUtil.prependCallLocation("Frame processing loop terminated."), e);
                            return;
                        }
                    }
                ...
                try {
                    ...
                    Log.e(TAG, LogUtil.prependCallLocation("Exception thrown from receiver."), t);
                } finally {
